    ...
    <>
      <div className="w-full lg:px-20 px-5 pt-0 pb-[80px] grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-10">
        <div data-aos='zoom-in' data-aos-delay='100' className="flex flex-col justify-center items-center gap-2">
          <img src={Shipping} alt="Payment" className="mb-[20px] w-[60px]" />
        ...
        <div data-aos='zoom-in' data-aos-delay='100' className="flex flex-col justify-center items-center gap-2">
          <img src={Payment1} alt="Payment" className="mb-[20px] w-[60px]" />
          <h1 className="text-xl text-black font-semibold">100% Secure Payment</h1>
          <p className="text-[17px] text-gray-500">Lorem ipsum dolor sit amet</p>
        </div>
        <div data-aos='zoom-in' data-aos-delay='100' className="flex flex-col justify-center items-center gap-2">
          <img src={Refund} alt="Payment" className="mb-[20px] w-[60px]" />
          <h1 className="text-xl text-black font-semibold">100% Cash-Back</h1>
          <p className="text-[17px] text-gray-500">Lorem ipsum dolor sit amet</p>
        </div>
        <div data-aos='zoom-in' data-aos-delay='100' className="flex flex-col justify-center items-center gap-2">
          <img src={Gift} alt="Payment" className="mb-[20px] w-[60px]" />
          <h1 className="text-xl text-black font-semibold">Free Boucher</h1>
          <p className="text-[17px] text-gray-500">Lorem ipsum dolor sit amet</p>
        </div>
