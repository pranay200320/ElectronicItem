...
const Productgrid = () => {
  ...
  return (
    <div id='products' className='w-full lg:px-20 px-5 py-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4'>
      <h1 data-aos='zoom-in' data-aos-delay='100' className='text-themepurpule text-xl font-semibold'>Browser Collectionas</h1>
          ...
          products.map((item, index) => (
            <div id='product-box' key={index} className='flex flex-col justify-center items-center gap-2 bg-white p-4 rounded-lg cursor-pointer relative'>
              ...
              <div id='icons' className='flex justify-center items-center gap-3 absolute top-[20px]'>
                <div className='bg-themepurpule hover:bg-themeyellow hover:text-black rounded-full p-3 text-white'>
              ...
              <h1 className='text-lg text-themepurpule font-semibold'>
                {item.price}
              </h1>
              <div>
                <hr />
                <div className='flex justify-between items-center gap-6 mt-3'>
                  <div className='flex justify-start items-center gap-1'>
                    <FaStar className='bg-themepurpule text-themeyellow' />
                    <FaStar className='bg-themepurpule text-themeyellow' />
                    <FaStar className='bg-themepurpule text-themeyellow' />
                    <FaStar className='bg-themepurpule text-themeyellow' />
                    <FaStar className='bg-themepurpule text-themeyellow' />
      ...
      <button data-aos='zoom-in' data-aos-delay='400' className='bg-themepurpule hover:bg-themeyellow text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-8'>VIEW MORE</button>
    </div>
  )
}
